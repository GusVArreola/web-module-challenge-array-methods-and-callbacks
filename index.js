...
console.log("a", fifaData[0]["Home Team Name"])
//(b) Away Team name for 2014 world cup final
console.log("b", fifaData[0]["Away Team Name"])
//(c) Home Team goals for 2014 world cup final
console.log("c", fifaData[0]["Home Team Goals"])
//(d) Away Team goals for 2014 world cup final
console.log("d", fifaData[0]["Away Team Goals"])
//(e) Winner of 2014 world cup final */
console.log("e", fifaData[0]["Win conditions"])
...
function getYears(fifaData) {
    const winningYears = getFinals(fifaData).map(data => data.Year)
    return (winningYears)
}
...
function getWinnersByYear(fifaData, cbFinals, cbYears, getWinners) {
    const yearlyFinalResultsArray = [];
    for (
      let index = 0;
      index < getYears(fifaData, cbFinals).length;
      index++
    ) {
      yearlyFinalResultsArray.push(
        `In ${cbYears(fifaData, cbFinals)[index]}, ${
          getWinners(fifaData, cbFinals)[index]
        } won the world cup!`
      );
    }
